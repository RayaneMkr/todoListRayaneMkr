...
public class InscriptionController {
    ...
    @FXML
   protected void OnActionInscription(ActionEvent event) throws SQLException {
        ...
        @FXML
   protected void OnActionRetour(ActionEvent event) {

    }
    @FXML
    protected void  OnActionConnexion() throws IOException {
